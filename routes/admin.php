...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function(){
    ...
    /** About-us Routes */
    Route::get('abouts', [AboutSectionController::class, 'index'])->name('about-section.index');
    Route::put('abouts', [AboutSectionController::class, 'update'])->name('about-section.update');
